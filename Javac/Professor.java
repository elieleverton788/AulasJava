...
public class Professor extends Usuario {
    ...
    public Professor(String nome, String cpf, int idade, String email_pessoal, String Area_de_formacao, int siape, String nivel_de_instrucao, List<Disciplina> disciplina) {
